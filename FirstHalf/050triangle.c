...
/* Interpolates to find the attr of x */
void getAttr(double a[], double b[], double c[], double x[2],  double attr[], double m[2][2], renRenderer *ren){
    ...
    double bMinusA[(ren->attrDim)]; double cMinusA[(ren->attrDim)];
    vecSubtract((ren->attrDim), b, a, bMinusA);
    vecSubtract((ren->attrDim), c, a, cMinusA);
    vecScale((ren->attrDim), pq[0], bMinusA, bMinusA);
    vecScale((ren->attrDim), pq[1], cMinusA, cMinusA);
    vecAdd((ren->attrDim), bMinusA, cMinusA, cMinusA);
    vecAdd((ren->attrDim), a, cMinusA, attr);
}
